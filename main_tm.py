...
def main(args: argparse.Namespace) -> None:
    ...
    optim_config["steps_per_epoch"] = len(wave_trn_loader)
    ...
    if n_swa_update > 0:
        try:
            ...
            optimizer_swa.bn_update(wave_trn_loader, model, device=device)
        except:
            pass
...
if __name__ == "__main__":
    ...
    parser.add_argument("--database_dir",
                        type=str,
                        default='./data/wavefake',
                        help="path to dataset")
    # parser.add_argument("--resume", action="store_true", help="resume from checkpoint")
    parser.add_argument("--resume", type=bool, default=False, help="resume from checkpoint")
    parser.add_argument("--pert_method", type=str, default="gaussian_noise", help="Specify perturbation to be added on audio for evaluation")
